...
"""
Performance profiling for city lookup functions in WorldTime for large city datasets
"""

import timeit
from worldtime.core import get_city_by_name, fuzzy_search_city
from worldtime.data import CITY_DB
...
def profile_lookup():
    ...
    import worldtime.data
    worldtime.data.CITY_DB = large_db
